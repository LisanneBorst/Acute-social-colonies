...
#SBATCH --ntasks=1
#SBATCH --job-name=NWB_event-trace
...
#python src/nwb_create_with_filtering.py >> logs/log_nwb_create.txt

#echo "Done with creating NWB files"
echo "Running nwb_add_event_trace.py ..."

python /scratch/p304163/all_drd2_analysis/taini_colonies/src/nwb_add_event_trace.py >> logs/log_nwb_add_event_trace.txt
